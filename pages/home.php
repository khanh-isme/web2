       ...
       <section class="main-home">
        ...
        <div class="product-section-a">
            ...
            <div class="product-container-a">
                <div class="product-a">
                    ...
                    <a href="product.html">
                    <img src="/web2/assets/images/11.png" alt="Nike C1TY 'Brownstone'">
                    </a>
                    
                    <h3>Nike C1TY 'Brownstone'</h3>
                    <p>Shoes</p>
                    <p class="price">2,929$</p>
                </div>
                <div class="product-a">
                    <a href="product.html">
                        
                        <img src="/web2/assets/images/10.png" alt="Nike Air Force 1 Shadow">
                ...
                <div class="product-a">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/7.png" alt="Nike Zoom Vomero Roam">
                        <h3>Nike Zoom Vomero Roam</h3>
                        <p>Men's Winterized Shoes</p>
                        <p class="price">5,279$</p>
                    </a>
                </div>
                ...
                <div class="product-a">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/8.jpg" alt="Nike Zoom Vomero Roam">
                        <h3>Nike Zoom Vomero Roam</h3>
                        <p>Men's Winterized Shoes</p>
                        <p class="price">5,279$</p>
                    </a>
                ...
                <div class="product-a">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/12.png" alt="Nike Zoom Vomero Roam">
                        <h3>Nike Zoom Vomero Roam</h3>
                        <p>Men's Winterized Shoes</p>
                        <p class="price">5,279$</p>
                    </a>
                ...
                <div class="product-a">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/13.png" alt="Nike Zoom Vomero Roam">
                        <h3>Nike Zoom Vomero Roam</h3>
                        <p>Men's Winterized Shoes</p>
                        <p class="price">5,279$</p>
                    </a>
        ...
        <section class="trending-product" id ="trending">
            ...
            <div class="product-container">
                <div class="product">
                    <a href="product.html">
                    <img src="/web2/assets/images/7.png" alt="">
                    </a>
                ...
                <div class="product">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/10.png" alt="">
                        <div class="product-text">
                            <h5> Sale</h5>
                        </div>
                        <div class="heart-icon">
                ...
                <div class="product">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/11.png" alt="">
                        <div class="product-text">
                            <h5> Sale</h5>
                        </div>
                        <div class="heart-icon">
                ...
                <div class="product">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/12.png" alt="">
                        <div class="product-text">
                            <h5> Sale</h5>
                        </div>
                        <div class="heart-icon">
                ...
                <div class="product">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/13.png" alt="">
                        <div class="product-text">
                            <h5> Sale</h5>
                        </div>
                        <div class="heart-icon">
                ...
                <div class="product">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/14.png" alt="">
                        <div class="product-text">
                            <h5> Sale</h5>
                        </div>
                        <div class="heart-icon">
                ...
                <div class="product">
                    <a href="product.html">
                        ...
                        <img src="/web2/assets/images/15.png" alt="">
                        <div class="product-text">
                            <h5> Sale</h5>
                        </div>
                        <div class="heart-icon">
                ...
                <div class="product">
                    <img src="/web2/assets/images/8.jpg" alt="">
                    <div class="product-text">
                        <h5> Sale</h5>
                    </div>
                    <div class="heart-icon">
